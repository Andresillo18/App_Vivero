 ...
 */
public class frmTblClientes extends javax.swing.JDialog {

    DefaultTableModel modelo;

    public frmTblClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
// <editor-fold desc="Limpiar Tabla" defaultstate="collapsed">    
    private void LimpiarTablas() {
        ...
        tblClientes.setModel(modelo); // La tabla se le establece el modelo y el modelo tiene los datos a ingresar
...
// </editor-fold>
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTblClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmTblClientes dialog = new frmTblClientes(new javax.swing.JFrame(), true);
